...
boundary (campaign B1.plan, 2026-05-26).

After the 581-LOC SKILL.md is split into a thin Kern (<=300 LOC) +
...
Modeled after `plugins/shipwright-project/tests/test_skill_references_link.py`.
"""
...
# linked from Kern). All 9 already exist before this split.
...
def test_kern_skill_md_under_300_loc() -> None:
    ...
    cleanup-invariant rule (a)). 581 -> ~250 was the spec target.
    """

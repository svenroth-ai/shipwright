...
Rules, all enforced by `check-sections.py` (Step 7) and by the plan phase
verifier at completion:
...
See [section-splitting.md](section-splitting.md) for the structure each file
should follow.

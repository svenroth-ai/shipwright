...
def plan_standard_writes(
    ...
    *,
    ...
    writes: list[ProposedWrite] = [
        ...
        ProposedWrite("compliance/test-evidence.md", "create", "stub — fills from first /shipwright-test"),
        ProposedWrite("compliance/dashboard.md", "create", "via shipwright-compliance"),

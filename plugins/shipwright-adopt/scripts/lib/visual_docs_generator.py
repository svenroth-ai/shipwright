...
- `agent_docs/design_tokens.md` — colors / spacing / typography / CSS vars
- `agent_docs/guideline.md` — single-page design-system summary, including
  a components inventory and a link to the persisted screenshots
- `agent_docs/visual/screenshots/` — copies of the crawl screenshots from
...
def _render_guideline_md(
    ...
    screenshot_block = (
        f"{screenshots_count} screenshot(s) persisted to `agent_docs/visual/screenshots/`."
    ...
    return (
        ...
        "## Colors\n\n"
        f"{color_summary}\n\n"
        "_Full token list: `agent_docs/design_tokens.md`._\n\n"
        "## Typography\n\n"
        f"{type_summary}\n\n"
        "## Components\n\n"
        f"{components_block}\n"
...
def _persist_screenshots(project_root: Path) -> int:
    ...
    dst_dir = project_root / "agent_docs" / "visual" / "screenshots"
...
def generate_visual_docs(
    ...
    for rel in ("agent_docs/design_tokens.md", "agent_docs/guideline.md"):

...
def write_spec(
    ...
    *,
    ...
    Returns both paths, spec first. ``catalogue`` may be passed in when a caller
    already summarised the same features.
    """
    catalogue = catalogue or summarize(features, split_name=split_name)

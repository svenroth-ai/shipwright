...
2. **After project phase:** "N splits created. Continue to planning?"
3. **After plan phase:** "M sections planned. Start building?"
4. **After build phase:** "All tests pass. Deploy to DEV?"
5. **After deploy:** "Smoke test passed. Create changelog + PR?"

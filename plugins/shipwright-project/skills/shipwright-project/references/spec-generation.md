...
Each split directory contains a `spec.md` that captures requirements and context for /shipwright-plan.
...
These spec files will get deep/thorough planning. They need enough context to kick off a deep planning session and no more.

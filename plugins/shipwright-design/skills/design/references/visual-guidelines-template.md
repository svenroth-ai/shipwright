...
Write `.shipwright/designs/visual-guidelines.md` based on interview answers and generated mockups:
...
**This file is designed to be reusable.** The user can upload it to `.shipwright/designs/uploads/` in their next project and skip the design interview.

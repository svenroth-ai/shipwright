...
# Multi-line shapes use explicit `+`: adjacent string literals in a list
# concatenate implicitly, so a missing comma would silently merge two shapes
# into one and drop a case from the corpus without failing anything (CodeQL
# py/implicit-string-concatenation-in-list). Silent coverage loss is the exact

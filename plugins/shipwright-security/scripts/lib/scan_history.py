...
The archive is what makes a run-to-run comparison possible at all — see
``scan_compare``, which reads two of these sidecars and reports a finding as
fixed only for the classes both runs actually covered.
"""

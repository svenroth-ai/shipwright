...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 287/287 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3751/3763 (2026-07-09) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 287/287 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (287 events, 2026-05-02 → 2026-07-10)`
...
Latest scan: **2026-07-09** · source `security.yml#29034378397` · critical-gate **✅ PASS**
...
| Work events (iterate) | 287 changes | INFO |  |
| Recent changes traced to an FR | 0/30 (0%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 3751/3763 | WARN | 12/3763 not green in last full suite — see test-evidence.md; +1 change(s) since last full suite |
...
- Iterate: 287 changes (2026-05-02 → 2026-07-10)

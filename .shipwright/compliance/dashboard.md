...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 18/20 FRs covered; 518/518 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 9880/9880 (2026-08-08) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 518/518 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ✅ | Size / maintainability discipline | ratchet delta -142 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (518 events, 2026-05-02 → 2026-08-09)`
...
Latest scan: **2026-08-09** · source `security.yml#31285260828` · critical-gate **✅ PASS**
...
| Bloat ratchet delta | -142 lines | PASS |  |

## Project Velocity

- Iterate: 518 changes (2026-05-02 → 2026-08-09)
...
**Last run 2026-07-28 (12 days earlier): FAIL** · 59 checks — 47 pass, 2 fail, 10 skip.

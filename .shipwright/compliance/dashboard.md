...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 290/290 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4749/4749 (2026-07-10) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 290/290 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (290 events, 2026-05-02 → 2026-07-10)`
...
Latest scan: **2026-07-10** · source `security.yml#29129882195` · critical-gate **✅ PASS**
...
- Iterate: 290 changes (2026-05-02 → 2026-07-10)

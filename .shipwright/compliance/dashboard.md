...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 285/285 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3749/3749 (2026-07-08) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 285/285 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ✅ | Size / maintainability discipline | ratchet delta -10 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (285 events, 2026-05-02 → 2026-07-08)`
...
Latest scan: **2026-07-08** · source `security.yml#28948728024` · critical-gate **✅ PASS**
...
| Triage open | 4 open (1 info) | WARN | 4 actionable item(s) — see ../agent_docs/triage_inbox.md |
| Bloat over-limit (grandfathered) | 127 | INFO |  |
| Bloat in allowlist | 158 entries | INFO |  |
| Bloat ratchet delta | -10 lines | PASS |  |

## Project Velocity

- Iterate: 285 changes (2026-05-02 → 2026-07-08)

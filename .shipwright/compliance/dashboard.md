...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 16/18 FRs covered; 370/370 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 10083/10083 (2026-07-27) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 370/370 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (370 events, 2026-05-02 → 2026-07-27)`
...
| Iterate tests passing | 54/76 testable changes tested | WARN | 22 testable change(s) without tests — see test-evidence.md |
...
- Iterate: 370 changes (2026-05-02 → 2026-07-27)

...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 266/266 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3666/3666 (2026-07-06) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 266/266 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (266 events, 2026-05-02 → 2026-07-06)`
...
Latest scan: **2026-07-06** · source `security.yml#28822060475` · critical-gate **✅ PASS**
...
- Iterate: 266 changes (2026-05-02 → 2026-07-06)

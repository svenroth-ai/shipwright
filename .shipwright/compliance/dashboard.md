...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 286/286 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3751/3763 (2026-07-09) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 286/286 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ⚠️ | Size / maintainability discipline | ratchet delta +11 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (286 events, 2026-05-02 → 2026-07-09)`
...
Latest scan: **2026-07-09** · source `security.yml#28998175877` · critical-gate **✅ PASS**
...
| Work events (iterate) | 286 changes | INFO |  |
| Recent changes traced to an FR | 0/30 (0%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 3751/3763 | WARN | 12/3763 not green in last full suite — see test-evidence.md |
...
| Bloat ratchet delta | +11 lines | WARN | grandfathered surface ratcheted up by 11 line(s) — Iron Law violation |

## Project Velocity

- Iterate: 286 changes (2026-05-02 → 2026-07-09)

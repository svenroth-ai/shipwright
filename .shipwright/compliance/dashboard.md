...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 250/250 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3905/3917 (2026-07-03) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 250/250 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (250 events, 2026-05-02 → 2026-07-04)`
...
Latest scan: **2026-07-04** · source `security.yml#28706933896` · critical-gate **✅ PASS**
...
| Work events (iterate) | 250 changes | INFO |  |
| Recent changes traced to an FR | 11/30 (37%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 3905/3917 | WARN | 12/3917 not green in last full suite — see test-evidence.md; +7 change(s) since last full suite |
...
- Iterate: 250 changes (2026-05-02 → 2026-07-04)

...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 19/20 FRs covered; 603/603 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 18522/18581 (2026-09-11) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 603/603 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (603 events, 2026-05-02 → 2026-09-11)`
...
Latest scan: **2026-09-11** · source `security.yml#34548196639` · critical-gate **✅ PASS**
...
| Work events (iterate) | 603 changes | INFO |  |
| Recent changes traced to an FR | 13/30 (43%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 18522/18581 | WARN | 59/18581 not green in last full suite — see test-evidence.md |
...
- Iterate: 603 changes (2026-05-02 → 2026-09-11)

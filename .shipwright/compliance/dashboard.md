...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 16/18 FRs covered; 360/360 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4946/4961 (2026-07-23) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 360/360 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ⚠️ | Size / maintainability discipline | ratchet delta +12 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (360 events, 2026-05-02 → 2026-07-27)`
...
Latest scan: **2026-07-27** · source `security.yml#30241112068` · critical-gate **✅ PASS**
...
| All unit tests passing | 4946/4961 | WARN | 15/4961 not green in last full suite — see test-evidence.md; +2 change(s) since last full suite |
...
| Bloat ratchet delta | +12 lines | WARN | grandfathered surface ratcheted up by 12 line(s) — Iron Law violation |

## Project Velocity

- Iterate: 360 changes (2026-05-02 → 2026-07-27)

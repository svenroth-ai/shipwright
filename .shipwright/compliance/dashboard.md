...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/15 FRs covered; 320/320 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 5936/5936 (2026-07-16) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 320/320 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ✅ | Size / maintainability discipline | ratchet delta -110 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (320 events, 2026-05-02 → 2026-07-17)`
...
Latest scan: **2026-07-17** · source `security.yml#29617627504` · critical-gate **✅ PASS**
...
| Bloat ratchet delta | -110 lines | PASS |  |

## Project Velocity

- Iterate: 320 changes (2026-05-02 → 2026-07-17)

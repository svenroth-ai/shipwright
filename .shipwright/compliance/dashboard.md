...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 272/272 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4081/4097 (2026-07-07) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 272/272 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (272 events, 2026-05-02 → 2026-07-07)`
...
| Work events (iterate) | 272 changes | INFO |  |
...
- Iterate: 272 changes (2026-05-02 → 2026-07-07)

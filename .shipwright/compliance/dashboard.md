...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/15 FRs covered; 338/338 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 5936/5936 (2026-07-16) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 338/338 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (338 events, 2026-05-02 → 2026-07-19)`
...
Latest scan: **2026-07-19** · source `security.yml#29687576163` · critical-gate **✅ PASS**
...
- Iterate: 338 changes (2026-05-02 → 2026-07-19)

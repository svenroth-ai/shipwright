...
> **Mostly controlled — verification gaps. Primarily capped by change reconciliation.**

### Control Grade: **C** (79/100) — Mostly controlled — verification gaps.

| | Dimension | Signal | Anchor |
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 16/18 FRs covered; 359/359 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4946/4961 (2026-07-23) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 359/359 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (359 events, 2026-05-02 → 2026-07-26)`
...
Latest scan: **2026-07-26** · source `security.yml#30192512414` · critical-gate **✅ PASS**
...
| Work events (iterate) | 359 changes | INFO |  |
| Recent changes traced to an FR | 10/30 (33%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 4946/4961 | WARN | 15/4961 not green in last full suite — see test-evidence.md; +1 change(s) since last full suite |
| Architecture decisions | 328 ADRs | INFO |  |
| Iterate tests passing | 53/68 testable changes tested | WARN | 15 testable change(s) without tests — see test-evidence.md |
| Dependencies | 11 packages | INFO |  |
| Copyleft risk | 0 | PASS |  |
| Triage open | 31 open | WARN | 31 actionable item(s) — see ../agent_docs/triage_inbox.md |
...
- Iterate: 359 changes (2026-05-02 → 2026-07-26)

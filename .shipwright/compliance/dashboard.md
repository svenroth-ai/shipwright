...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 16/18 FRs covered; 361/361 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4946/4961 (2026-07-23) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 361/361 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (361 events, 2026-05-02 → 2026-07-27)`
...
Latest scan: **2026-07-27** · source `security.yml#30248911151` · critical-gate **✅ PASS**
...
| Work events (iterate) | 361 changes | INFO |  |
| Recent changes traced to an FR | 10/30 (33%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 4946/4961 | WARN | 15/4961 not green in last full suite — see test-evidence.md; +3 change(s) since last full suite |
...
- Iterate: 361 changes (2026-05-02 → 2026-07-27)

...
| All unit tests passing | 10107/10107 | PASS |  |
| Architecture decisions | 328 ADRs | INFO |  |
| Iterate tests passing | 54/69 testable changes tested | WARN | 15 testable change(s) without tests — see test-evidence.md |
...
| Bloat ratchet delta | +5 lines | WARN | grandfathered surface ratcheted up by 5 line(s) — Iron Law violation |

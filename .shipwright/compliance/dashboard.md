...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/15 FRs covered; 300/300 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
...
Verified from: `shipwright_events.jsonl (300 events, 2026-05-02 → 2026-07-14)`
...
Latest scan: **2026-07-14** · source `security.yml#29366890209` · critical-gate **✅ PASS**
...
- Iterate: 300 changes (2026-05-02 → 2026-07-14)

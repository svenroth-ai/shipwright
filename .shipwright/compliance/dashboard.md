...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 257/257 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
...
Verified from: `shipwright_events.jsonl (257 events, 2026-05-02 → 2026-07-05)`
...
| Work events (iterate) | 257 changes | INFO |  |
...
- Iterate: 257 changes (2026-05-02 → 2026-07-05)

...
| Work events (iterate) | 148 changes | INFO |  |
| All unit tests passing | 0/0 | WARN | no test events recorded yet |
| Architecture decisions | 141 ADRs | INFO |  |
| Iterate tests passing | 90/148 iterations tested | WARN | 58 iterate(s) without tests — see test-evidence.md |
...
| Bloat ratchet delta | -135 lines | PASS |  |

## Project Velocity

- Iterate: 148 changes (2026-05-02 → 2026-06-12)

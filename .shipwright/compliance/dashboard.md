...
| Work events (iterate) | 64 changes | INFO |  |
| All unit tests passing | 0/0 | WARN | no test events recorded yet |
| Architecture decisions | 88 ADRs | INFO |  |
| Iterate tests passing | 49/64 iterations tested | WARN | 15 iterate(s) without tests — see test-evidence.md |
...
- Iterate: 64 changes (2026-05-02 → 2026-05-27)

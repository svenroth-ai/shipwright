...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 247/247 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3905/3917 (2026-07-03) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 247/247 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (247 events, 2026-05-02 → 2026-07-04)`
...
| Work events (iterate) | 247 changes | INFO |  |
| Recent changes traced to an FR | 13/30 (43%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 3905/3917 | WARN | 12/3917 not green in last full suite — see test-evidence.md; +4 change(s) since last full suite |
...
- Iterate: 247 changes (2026-05-02 → 2026-07-04)

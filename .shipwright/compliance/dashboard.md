...
Generated: 2026-07-31T09:23:48.769197+00:00
Source-State: run=iterate-2026-07-31-it7a-pr-review-stale-verdict
...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 18/19 FRs covered; 413/413 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 7621/7637 (2026-07-31) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 413/413 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (413 events, 2026-05-02 → 2026-07-31)`
...
Latest scan: **2026-07-31** · source `security.yml#30617044154` · critical-gate **✅ PASS**
...
| Work events (iterate) | 413 changes | INFO |  |
| Recent changes traced to an FR | 17/30 (57%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 7621/7637 | WARN | 16/7637 not green in last full suite — see test-evidence.md; +1 change(s) since last full suite |
| Architecture decisions | 328 ADRs | INFO |  |
| Iterate tests passing | 57/104 testable changes tested | WARN | 47 testable change(s) without tests — see test-evidence.md |
| Dependencies | 11 packages | INFO |  |
| Copyleft risk | 0 | PASS |  |
| Triage open | 23 open | WARN | 23 actionable item(s) — see ../agent_docs/triage_inbox.md |
| Bloat over-limit (grandfathered) | 135 | INFO |  |
| Bloat in allowlist | 170 entries | INFO |  |
| Bloat ratchet delta | -42 lines | PASS |  |

## Project Velocity

- Iterate: 413 changes (2026-05-02 → 2026-07-31)

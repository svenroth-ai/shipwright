...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 220/220 changes traced (FR-linked or classified no-FR) | DO-178C §11.9 / IEC 62304 / ALM RTM |
| ✅ | Test health | latest full suite 3853/3853 (2026-06-28) | coverage gating (SonarQube 'Sonar Way') |
| ✅ | Change traceability | 220/220 changes linked to a commit, ADR or test run | SLSA provenance / OpenSSF Code-Review |
...
Verified from: `shipwright_events.jsonl (220 events, 2026-05-02 → 2026-06-28)`
...
| Work events (iterate) | 220 changes | INFO |  |
...
| Iterate tests passing | 139/220 iterations tested | WARN | 81 iterate(s) without tests — see test-evidence.md |
...
- Iterate: 220 changes (2026-05-02 → 2026-06-28)

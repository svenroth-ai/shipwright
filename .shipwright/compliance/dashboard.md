...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 20/20 FRs covered; 655/655 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 11198/11198 (2026-09-21) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 655/655 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (655 events, 2026-05-02 → 2026-09-21)`
...
Latest scan: **2026-09-20** · source `security.yml#35541231616` · critical-gate **✅ PASS**
...
| Work events (iterate) | 655 changes | INFO |  |
| Recent changes traced to an FR | 17/30 (57%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 11198/11198 | PASS |  |
| Architecture decisions | 397 ADRs | INFO |  |
| Iterate tests passing | 114/167 testable changes tested | WARN | 53 testable change(s) without tests — see test-evidence.md |
| Dependencies | 12 packages | INFO |  |
| Copyleft risk | 0 | PASS |  |
| Triage open | 11 open | WARN | 11 actionable item(s) — see ../agent_docs/triage_inbox.md |
| Bloat over-limit (grandfathered) | 170 | INFO |  |
| Bloat in allowlist | 236 entries | INFO |  |
| Bloat ratchet delta | -199 lines | PASS |  |

## Project Velocity

- Iterate: 655 changes (2026-05-02 → 2026-09-21)
...
**Last run 2026-07-28 (55 days earlier): FAIL** · 59 checks — 47 pass, 2 fail, 10 skip.

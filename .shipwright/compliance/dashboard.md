...
| All unit tests passing | 10083/10083 | PASS |  |
| Architecture decisions | 328 ADRs | INFO |  |
| Iterate tests passing | 54/74 testable changes tested | WARN | 20 testable change(s) without tests — see test-evidence.md |

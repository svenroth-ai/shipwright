...
| Work events (iterate) | 79 changes | INFO |  |
| All unit tests passing | 0/0 | WARN | no test events recorded yet |
| Architecture decisions | 88 ADRs | INFO |  |
| Iterate tests passing | 55/79 iterations tested | WARN | 24 iterate(s) without tests — see test-evidence.md |
...
| Bloat ratchet delta | -27 lines | PASS |  |

## Project Velocity

- Iterate: 79 changes (2026-05-02 → 2026-05-31)

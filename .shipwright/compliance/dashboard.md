...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/15 FRs covered; 311/311 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4572/4572 (2026-07-16) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 311/311 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (311 events, 2026-05-02 → 2026-07-16)`
...
Latest scan: **2026-07-16** · source `security.yml#29483868058` · critical-gate **✅ PASS**
...
- Iterate: 311 changes (2026-05-02 → 2026-07-16)

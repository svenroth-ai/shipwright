...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 291/291 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4749/4749 (2026-07-10) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 291/291 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (291 events, 2026-05-02 → 2026-07-11)`
...
Latest scan: **2026-07-11** · source `security.yml#29132471666` · critical-gate **✅ PASS**
...
| Work events (iterate) | 291 changes | INFO |  |
| Recent changes traced to an FR | 0/30 (0%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 4749/4749 | PASS | +3 change(s) since last full suite |
| Architecture decisions | 310 ADRs | INFO |  |
...
- Iterate: 291 changes (2026-05-02 → 2026-07-11)

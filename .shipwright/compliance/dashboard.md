...
| Work events (iterate) | 118 changes | INFO |  |
| All unit tests passing | 0/0 | WARN | no test events recorded yet |
| Architecture decisions | 138 ADRs | INFO |  |
| Iterate tests passing | 73/118 iterations tested | WARN | 45 iterate(s) without tests — see test-evidence.md |
...
- Iterate: 118 changes (2026-05-02 → 2026-06-07)

...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 19/20 FRs covered; 578/578 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 17363/17422 (2026-09-07) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 578/578 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (578 events, 2026-05-02 → 2026-09-07)`
...
Latest scan: **2026-09-07** · source `security.yml#34116352328` · critical-gate **✅ PASS**
...
| Work events (iterate) | 578 changes | INFO |  |
| Recent changes traced to an FR | 5/30 (17%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 17363/17422 | WARN | 59/17422 not green in last full suite — see test-evidence.md; +1 change(s) since last full suite |
...
| Bloat over-limit (grandfathered) | 176 | INFO |  |
| Bloat in allowlist | 227 entries | INFO |  |
| Bloat ratchet delta | +0 lines | PASS |  |

## Project Velocity

- Iterate: 578 changes (2026-05-02 → 2026-09-07)

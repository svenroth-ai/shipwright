...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 253/253 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3905/3917 (2026-07-03) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 253/253 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Latest scan: **2026-07-04** · source `security.yml#28719714629` · critical-gate **✅ PASS**
...
| Work events (iterate) | 253 changes | INFO |  |
| Recent changes traced to an FR | 9/30 (30%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 3905/3917 | WARN | 12/3917 not green in last full suite — see test-evidence.md; +10 change(s) since last full suite |

...
| Work events (iterate) | 74 changes | INFO |  |
| All unit tests passing | 0/0 | WARN | no test events recorded yet |
| Architecture decisions | 88 ADRs | INFO |  |
| Iterate tests passing | 55/74 iterations tested | WARN | 19 iterate(s) without tests — see test-evidence.md |
...
- Iterate: 74 changes (2026-05-02 → 2026-05-30)

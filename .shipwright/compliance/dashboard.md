...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 279/279 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4067/4087 (2026-07-07) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 279/279 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (279 events, 2026-05-02 → 2026-07-07)`
...
Latest scan: **2026-07-07** · source `security.yml#28894365723` · critical-gate **✅ PASS**
...
| Work events (iterate) | 279 changes | INFO |  |
| Recent changes traced to an FR | 0/30 (0%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 4067/4087 | WARN | 20/4087 not green in last full suite — see test-evidence.md; +4 change(s) since last full suite |
...
- Iterate: 279 changes (2026-05-02 → 2026-07-07)

...
| All unit tests passing | 10083/10083 | PASS | +4 change(s) since last full suite |
| Architecture decisions | 328 ADRs | INFO |  |
| Iterate tests passing | 54/77 testable changes tested | WARN | 23 testable change(s) without tests — see test-evidence.md |

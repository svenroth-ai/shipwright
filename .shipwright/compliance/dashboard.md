...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/15 FRs covered; 339/339 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 5936/5936 (2026-07-16) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 339/339 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ✅ | Size / maintainability discipline | ratchet delta -25 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (339 events, 2026-05-02 → 2026-07-20)`
...
Latest scan: **2026-07-20** · source `security.yml#29712945709` · critical-gate **✅ PASS**
...
| Bloat ratchet delta | -25 lines | PASS |  |

## Project Velocity

- Iterate: 339 changes (2026-05-02 → 2026-07-20)

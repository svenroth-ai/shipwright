...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/15 FRs covered; 342/342 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 9458/9486 (2026-07-20) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 342/342 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (342 events, 2026-05-02 → 2026-07-20)`
...
Latest scan: **2026-07-20** · source `security.yml#29744241893` · critical-gate **✅ PASS**
...
| Work events (iterate) | 342 changes | INFO |  |
| Recent changes traced to an FR | 5/30 (17%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 9458/9486 | WARN | 28/9486 not green in last full suite — see test-evidence.md |
...
- Iterate: 342 changes (2026-05-02 → 2026-07-20)

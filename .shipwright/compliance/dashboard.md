...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 18/20 FRs covered; 550/550 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 16856/16912 (2026-08-26) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 550/550 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (550 events, 2026-05-02 → 2026-08-26)`
...
Latest scan: **2026-08-26** · source `security.yml#32945925095` · critical-gate **✅ PASS**
...
| Work events (iterate) | 550 changes | INFO |  |
| Recent changes traced to an FR | 7/30 (23%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 16856/16912 | WARN | 56/16912 not green in last full suite — see test-evidence.md |
...
| Bloat over-limit (grandfathered) | 151 | INFO |  |
| Bloat in allowlist | 202 entries | INFO |  |
| Bloat ratchet delta | -337 lines | PASS |  |

## Project Velocity

- Iterate: 550 changes (2026-05-02 → 2026-08-26)

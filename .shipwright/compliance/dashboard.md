...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 19/20 FRs covered; 596/596 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 10384/10385 (2026-09-10) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 596/596 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (596 events, 2026-05-02 → 2026-09-10)`
...
Latest scan: **2026-09-10** · source `security.yml#34496487227` · critical-gate **✅ PASS**
...
| Work events (iterate) | 596 changes | INFO |  |
| Recent changes traced to an FR | 8/30 (27%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 10384/10385 | WARN | 1/10385 not green in last full suite — see test-evidence.md |
...
- Iterate: 596 changes (2026-05-02 → 2026-09-10)

...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 20/21 FRs covered; 661/661 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 19722/19799 (2026-09-22) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 661/661 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (661 events, 2026-05-02 → 2026-09-22)`
...
| Work events (iterate) | 661 changes | INFO |  |
| Recent changes traced to an FR | 15/30 (50%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 19722/19799 | WARN | 77/19799 not green in last full suite — see test-evidence.md; +1 change(s) since last full suite |
...
- Iterate: 661 changes (2026-05-02 → 2026-09-22)

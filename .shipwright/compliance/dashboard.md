...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 284/284 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3749/3749 (2026-07-08) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 284/284 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (284 events, 2026-05-02 → 2026-07-08)`
...
Latest scan: **2026-07-08** · source `security.yml#28934907268` · critical-gate **✅ PASS**
...
- Iterate: 284 changes (2026-05-02 → 2026-07-08)

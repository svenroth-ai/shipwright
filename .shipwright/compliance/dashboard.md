...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 217/217 changes traced (FR-linked or classified no-FR) | DO-178C §11.9 / IEC 62304 / ALM RTM |
| ✅ | Test health | latest full suite 4719/4719 (2026-06-28) | coverage gating (SonarQube 'Sonar Way') |
| ✅ | Change traceability | 217/217 changes linked to a commit, ADR or test run | SLSA provenance / OpenSSF Code-Review |
...
| ✅ | Size / maintainability discipline | ratchet delta -131 lines (net growth) | ISO 25010 maintainability / SonarQube |
| ✅ | Dependency hygiene | 0 unresolved / 8 licenses; 0 copyleft | OWASP A06:2021 / OpenSSF Scorecard |

Verified from: `shipwright_events.jsonl (217 events, 2026-05-02 → 2026-06-28)`
...
| Work events (iterate) | 217 changes | INFO |  |
...
| All unit tests passing | 4719/4719 | PASS | +2 change(s) since last full suite |
| Architecture decisions | 235 ADRs | INFO |  |
| Iterate tests passing | 137/217 iterations tested | WARN | 80 iterate(s) without tests — see test-evidence.md |
...
| Bloat ratchet delta | -131 lines | PASS |  |

## Project Velocity

- Iterate: 217 changes (2026-05-02 → 2026-06-28)

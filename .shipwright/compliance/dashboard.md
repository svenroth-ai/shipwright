...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 293/293 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4749/4749 (2026-07-10) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 293/293 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (293 events, 2026-05-02 → 2026-07-11)`
...
Latest scan: **2026-07-11** · source `security.yml#29136983884` · critical-gate **✅ PASS**
...
- Iterate: 293 changes (2026-05-02 → 2026-07-11)

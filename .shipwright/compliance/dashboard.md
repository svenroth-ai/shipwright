...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 15/16 FRs covered; 360/360 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 5548/5559 (2026-07-26) | automated tests pass (OpenSSF Scorecard) |
...
| ✅ | Size / maintainability discipline | ratchet delta -207 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (360 events, 2026-05-02 → 2026-07-26)`
...
Latest scan: **2026-07-24** · source `security.yml#30075246969` · critical-gate **✅ PASS**
...
| All unit tests passing | 5548/5559 | WARN | 11/5559 not green in last full suite — see test-evidence.md |
...
| Bloat ratchet delta | -207 lines | PASS |  |

## Project Velocity

- Iterate: 360 changes (2026-05-02 → 2026-07-26)

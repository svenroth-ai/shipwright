...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 294/294 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 4749/4749 (2026-07-10) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 294/294 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
| ⚠️ | Size / maintainability discipline | ratchet delta +76 lines (net growth) | no unchecked code-size growth (ISO/IEC 25010) |
...
Verified from: `shipwright_events.jsonl (294 events, 2026-05-02 → 2026-07-11)`
...
Latest scan: **2026-07-11** · source `security.yml#29139014738` · critical-gate **✅ PASS**
...
| Bloat ratchet delta | +76 lines | WARN | grandfathered surface ratcheted up by 76 line(s) — Iron Law violation |

## Project Velocity

- Iterate: 294 changes (2026-05-02 → 2026-07-11)

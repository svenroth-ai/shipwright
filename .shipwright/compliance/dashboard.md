...
|---|-----------|--------|--------|
| ✅ | Requirement traceability | 14/14 FRs covered; 248/248 changes traced (FR-linked or classified no-FR) | requirement-to-work traceability (ISO/IEC/IEEE 29148) |
| ✅ | Test health | latest full suite 3905/3917 (2026-07-03) | automated tests pass (OpenSSF Scorecard) |
| ✅ | Change traceability | 248/248 changes linked to a commit, ADR or test run | change provenance (SLSA) |
...
Verified from: `shipwright_events.jsonl (248 events, 2026-05-02 → 2026-07-04)`
...
Latest scan: **2026-07-04** · source `security.yml#28701316324` · critical-gate **✅ PASS**
...
| Work events (iterate) | 248 changes | INFO |  |
| Recent changes traced to an FR | 12/30 (40%) | INFO | feature vs. maintenance mix — informational, does not affect the Control Grade |
| All unit tests passing | 3905/3917 | WARN | 12/3917 not green in last full suite — see test-evidence.md; +5 change(s) since last full suite |
...
- Iterate: 248 changes (2026-05-02 → 2026-07-04)

...
| 2026-07-27 | design,build | bind the evidence mode to the phase, restore source_state | 0b16490af7b8 |
...
| Date | Scope | Description | Commit |
|------|-------|-------------|--------|
| 2026-07-27 | churn | regenerate derived snapshots after main merge | 5bfca2f74abe |

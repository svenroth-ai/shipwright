...
> Auto-generated 2026-07-31T10:12:33.870577Z. Items waiting for triage decision.
> Promote via WebUI Triage tab (when v1b lands) or `shared/scripts/tools/triage_promote.py --id <id> --task-ref EXT:<ref>`.

## Status summary

- Total: 525
- Triage: 23 | Promoted: 1 | Dismissed: 499 | Snoozed: 2
...
### Source: shipwright-webui iterate-2026-07-29-accepted-risk-ci-gate (external + Codex review) (3 items)
...
<a id="trg-6098697b"></a>
- **SecFix-3: accepted-risk gate - reconcile with no register, honour ignore-file expiry, add an inline-suppression target** `id=trg-6098697b | severity=medium | kind=improvement → P2/engineering`
  - Filed from shipwright-webui, where the accepted-risk gate was first wired into CI (webui PR #332). Group SecFix-1..3 be…
  - Promote: `triage_promote.py --id trg-6098697b --task-ref EXT:<ref>`

...
> Auto-generated 2026-07-07T12:34:00.634683Z. Items waiting for triage decision.
> Promote via WebUI Triage tab (when v1b lands) or `shared/scripts/tools/triage_promote.py --id <id> --task-ref EXT:<ref>`.

## Status summary

- Total: 274
- Triage: 4 | Promoted: 1 | Dismissed: 268 | Snoozed: 1
...
<a id="trg-db81291b"></a>
- **Compliance: 2 open finding(s)** `id=trg-db81291b | severity=high | kind=compliance → P1/compliance`
  - 2 open compliance finding(s): H/H1, H/H2  - H/H1: Bloat drift (oversize file not in baseline) — shared/scripts/hooks/ph…
  - Launch payload (copy into a new Claude session):
    ...
    ```
  - Promote: `triage_promote.py --id trg-db81291b --task-ref EXT:<ref>`

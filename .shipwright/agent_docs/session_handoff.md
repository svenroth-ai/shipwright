...
- **Context:** The WebUI Ship's-Log Grade-Trend needs grade HISTORY, but the Control Grade is a repo aggregate the compliance dashboard overwrites on every regen — no history survived (M-Pre-3). No producer emitted a durable per-run grade

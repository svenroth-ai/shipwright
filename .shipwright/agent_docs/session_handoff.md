...
phase: "iterate"
reason: "F11 pre-merge refresh: iterate-2026-06-28-drop-timestamp-drift"
...
- **Branch**: iterate/drop-timestamp-drift
- **Last Commit**: 6cff4a22 Merge remote-tracking branch 'origin/main' into iterate/drop-timestamp-drift

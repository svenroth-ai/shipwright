...
phase: "iterate"
reason: "iterate: surface-aware run hand-off banner"
...
- **Last iterate**: change — surface-aware /shipwright-run hand-off banner via CLAUDE_CODE_ENTRYPOINT (2026-07-06)

...
- (E) Given the two outside reviewers reached opposite conclusions about the
  ...
  reviewer's conclusion could not be read at all: an unreadable answer is not
  agreement. Two independent reviewers exist so that disagreement is noticed,
  which a single count of findings cannot show.

...
- [Anchor Layers-promotion to the newest verified ancestor](iterate-2026-09-10-p34c-promotion-anchor-guard-anchor-design.md)
- [ADR: Grandfather promote_required_layers.py + its supporting files as a bloat exception](iterate-2026-09-10-p34c-promotion-anchor-guard-bloat-exception.md)
...
- [CI supply-chain ack authorship guard](iterate-2026-09-11-ci-supplychain-ack-authorship-decision.md)
...
- [mark_status reports its outbox-vs-tracked write target](iterate-2026-09-12-triage-route-report-mark-status-route-reporting.md)
- [Bloat exception — review-record schema/CLI gain `transport`; transport module hardened after doubt-review](iterate-2026-09-13-codex-internal-review-transport-bloat-exception.md)
- [Codex CLI as a fallback transport for the internal review cascade](iterate-2026-09-13-codex-internal-review-transport-design.md)
...
- [Codex first-eligible-call gate (M3, R2)](iterate-2026-09-20-r2-m3-hook-parity-iterate-only-codex-first-call-gate.md)
...
- [Bloat exception — `plugins/shipwright-iterate/skills/iterate/references/campaign-mode.md` (first crossing 400 → 447; current ceiling in the latest entry below)](iterate-2026-09-22-r3-review-diff-fix-bloat-exception.md)
...
- [Bloat exception — `plugins/shipwright-iterate/skills/iterate/references/campaign-mode.md` raised to 1011-LOC](iterate-2026-09-23-r5a-wave-build-flip-campaign-mode-bloat-exception.md)
- [Bloat exception — `shared/scripts/lib/phase_quality/_run_id.py` raised to 305-LOC](iterate-2026-09-23-r5a-wave-build-flip-run-id-bloat-exception.md)

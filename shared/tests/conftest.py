...
import pytest
pytest_plugins = ("shared.tests.source_state_capture_isolation", "shared.tests.codex_review_env_isolation")
...
def _sweep_tests_unset_ci(request, monkeypatch):
    ...
    if request.path.name.startswith(("test_sweep", "test_d2v_empirical_gate", "test_triage_outbox", "test_github_triage_prompt_artifact", "test_triage_cli_amend", "test_triage_route_report")):

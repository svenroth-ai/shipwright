...
_DEFAULT_SYSTEM = {
    ...
    "architecture": (
        ...
        "would do? Many changes add none, and this review runs on those too: a "
        "brief saying \"Nothing. This changes machinery that already exists\" is "
        "the normal case, not an omission — do not hunt for a mechanism it does "
        "not claim; answer whether changing that existing machinery is "
        "proportionate, and stop. You are reading a short brief, not a plan. The options it "
